...
export const EditMedicine = () => {
    ...
    const { getMedicineById, updateMedicine, loadingMedicineId } = useProvider();
    ...
    const fetchMedicineId = async (id) => {
                        ...
                        <div className="relative flex flex-col min-w-0 break-words bg-white border-0 shadow-xl rounded-2xl bg-clip-border">
                            <div className="border-black/12.5 rounded-t-2xl border-b-0 border-solid p-6 pb-0">
                                <div className="flex items-center">
                                    <p className="mb-0 uppercase">MEDICAMENTO  </p>
                                </div>
                            </div>
                                    ...
                                    <div className="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                        <div className="mb-4">
                                            ...
                                            <input
                                                ...
                                                value={(medicine) ? medicine.nombre:''}
                                    ...
                                    <div className="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                        <div className="mb-4">
                                            ...
                                            <input
                                                ...
                                                name="descripcion"
                                                onChange={handleChange}
                                                value={(medicine) ? medicine.descripcion:''} className="focus:shadow-primary-outline dark:bg-slate-850  text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" />
                                        </div>
                                    </div>
